    ...
    internal static class Node
    {
        ...
        public static NodeType Type(NodeId nodeId)
        {
            return nodeId switch
            {
                ...
                NodeId.SplitterOutput1Patch => NodeType.PatchSource,
                NodeId.SplitterOutput2Patch => NodeType.PatchSource,
                NodeId.SplitterInputPatch => NodeType.PatchSink,
        ...
        public static string Name(NodeId nodeId)
        {
            return nodeId switch
            {
                ...
                NodeId.SplitterOutput1Patch => "Splitter Out 1",
                NodeId.SplitterOutput2Patch => "Splitter Out 2",
                NodeId.SplitterInputPatch => "Splitter Input",
        ...
        public static string Nickname(NodeId nodeId)
        {
            return nodeId switch
            {
                ...
                NodeId.SplitterOutput1Patch => "Split Out 1",
                NodeId.SplitterOutput2Patch => "Split Out 2",
                NodeId.SplitterInputPatch => "Split In",
        ...
        public static int DisplayOrder(NodeId nodeId)
        {
            return nodeId switch
            {
                ...
                NodeId.SanctuaryPatch => 51,
                NodeId.SanctuaryProjector => 52,
                NodeId.SocHallNorthPatch => 44,
                NodeId.SocHallNorthProjector => 45,
                NodeId.SocHallSouthPatch => 46,
                NodeId.SocHallSouthProjector => 47,
                NodeId.SplitterOutput1Patch => 37,
                NodeId.SplitterOutput2Patch => 38,
                NodeId.SplitterInputPatch => 39,
